...
export default class About extends React.Component {
  ...
  getContribs() {
    axios
      .get('http://api.roadtripr.fun/contribs/')
      .then(res => {
          ...
          <div className="container">
            <header className="section-header">
              ...
              <p>A road trip, in its most primitive definition, is a long journey undertaken
                ...
                development progress have all played a role in changing our society and thereby
                altering much of our old conduct of various activities. Gone are the days of
                flipping through maps and printing out directions, yet the sentimentality and
                metamorphosis associated with road-trips have not changed. Nowadays, planning a
                road-trip incorporates much of the tech aspects that are supposed to bring ease
                and simplicity to a once chaotic task, however these applications normally have
                to be used separately. With this site, users will be able to access all relevant
                information in relation to their interests in each component. We hope to widen
                the breadth of their knowledge regarding the sites they plan to visit by
                including additional facts and invaluable reviews. Our team consists of travel
                aficionados who are rather well versed in the art of road-tripping. Thus, this
                project is the culmination of our experiences - understanding some of the
                problems that can arise when planning and incorporating our own solutions to
                such problems.</p>
            </header>
            ...
            <div className="row contact-info">
              <div className="col-lg-4">
                <div className="contact-address">
                  ...
                  <p>
                    <a href="https://www.nps.gov/subjects/digital/nps-data-api.htm">National Parks Service</a>
                  </p>
              ...
              <div className="col-lg-4">
                <div className="contact-email">
                  ...
                  <h3>Links</h3>
                  <p>
                    <a href="https://www.gitbook.com/book/huangyvonnee/roadtripr/">Gitbook</a>
                  </p>
                  <p>
                  ...
                  <p>
                  <a href="https://huangyvonnee.github.io/visualization.html">D3 Visualization</a>
               </p>
                </div>
              </div>
            </div>
